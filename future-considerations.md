...
- ⏳ The ~14 bespoke tables are still hand-rolled rather than sharing a `DataTable`; TanStack Table is installed but used only by the documents browser. Deliberately treated as a separate, larger follow-up rather than bundled into this pass.
